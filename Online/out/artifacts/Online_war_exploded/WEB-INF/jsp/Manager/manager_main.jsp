    ...
    <div class="navbar-inverse navbar-static-top" role="navigation" id="top-menu">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="${pageContext.request.contextPath}/toManagerMain.action">首页</a> </li>
    ...
    <%--右侧主要内容    --%>
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div id="page1">
                        <img src="${pageContext.request.contextPath}/images/background4.png" id="back1" style="width: 320px;height: 320px;margin-left: 5px">
                        <div class="caption" style="margin-top: 5px">
                            <p>
                                 <h4 style="text-align: center">用户管理</h4>
                                <a href="${pageContext.request.contextPath}/list.action" class="btn btn-primary" role="button" style="margin-left: 140px">前往</a>
                            </p>
                        </div>
                    </div>
