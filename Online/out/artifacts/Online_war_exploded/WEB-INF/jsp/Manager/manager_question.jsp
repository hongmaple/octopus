        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li class="active"><a href="${pageContext.request.contextPath}/listQuestion.action">题库管理</a> </li>
                </ul>
            </li>
            <li><a href="${pageContext.request.contextPath}/toManagerScore.action">成绩管理</a> </li>
            <li><a href="#">模拟考试</a> </li>
        </ul>
            ...
            <ul id="main-nav" class="nav nav-tabs nav-stacked">
                ...
                <li>
                    ...
                    <ul id="papermanager" class="nav nav-list collapse secondmenu" style="height: 0px;">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/listQuestion.action"><i class="glyphicon glyphicon-globe">题库管理</i> </a> </li>
                    </ul>
                </li>
                <li>
                    <a href="#">
