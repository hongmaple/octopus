...
public class EduStudent extends BaseEntity {
     ...
     * 所属班级
     */
    @Excel(name = "所属班级",type = Excel.Type.IMPORT)
     ...
     * 所学专业
     */
    @Excel(name = "所学专业",type = Excel.Type.IMPORT)
     ...
     */
    @Excels({
            @Excel(name = "登录名称",targetAttr = "loginName",type = Excel.Type.EXPORT),
            @Excel(name = "昵称",targetAttr = "userName",type = Excel.Type.EXPORT),
            @Excel(name = "邮箱",targetAttr = "email",type = Excel.Type.EXPORT),
            @Excel(name = "手机号码",targetAttr = "phonenumber",type = Excel.Type.EXPORT),
            @Excel(name = "性别", readConverterExp = "0=男,1=女,2=未知",targetAttr = "sex",type = Excel.Type.EXPORT),
            @Excel(name = "帐号状态", readConverterExp = "0=正常,1=停用",targetAttr = "status",type = Excel.Type.EXPORT),
    })
     ...
     * 所学专业名
     */
    @Excel(name = "所学专业名",type = Excel.Type.EXPORT)
    private String majorstudiedName;

    /**
     * 所属班级名
     */
    @Excel(name = "所属班级名",type = Excel.Type.EXPORT)
